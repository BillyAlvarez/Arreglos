...
public class EjemploArregloNotasAlumnos {
    public static void main(String[] args) {
        ...
        System.out.println("El promedio de la clase Matematica = " + promedioMatematica);
        System.out.println("El promedio de la clase Historia = " + promedioHistoria);
        System.out.println("El promedio de la clase Lenguaje = " + promedioLenguaje);
        System.out.println("" +
        ...
        System.out.println("El promedio del alumno Nro = " + id + " es : " + promedioAlumno);
